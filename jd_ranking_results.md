...
|------:|-----:|---------|------|-------|
| **100** | <25 | 🟢 Apply now | **Wellspring — Solutions Consultant** | Enterprise B2B SaaS pre-sales; discovery/demos/RFP; remote WE + 25% travel; FR/EU language plus; strongest lane match |
| **68** | — | 🟠 Apply if time | **IRC — Sr Mgr SC Digitalization Pilots** | Humanitarian NGO SC pilots/benchmarking; EN + FR preferred; remote TWG — weak Comp vs SaaS solutions (NGO program shape) |
| **55** | — | 🟠 Stretch | Luvent — Project Manager (French) | Donor-funded intl consulting PM; Berlin/remote; FR required — NGO/donor PM, not software delivery |
| **55** | 115 | 🟠 Stretch | KWS — Procurement Risk & Sustainability Mgr | 14-mo maternity cover; procurement ESG/LkSG — not SaaS solutions; high apps |
| **41** | — | 🔴 Skip / low | OSF — Grants Officer (Berlin hybrid) | Grants admin / NGO ops — wrong lane |
| **Skip** | — | 🔴 Skip | **Almedia — AI Operations Specialist** | Explicit “not a 9–5 / reward intensity” — named hard DQ in profile |

### Wellspring — why 100
| Factor | Detail |
|--------|--------|
| **Lane** | Solutions Consultant / enterprise pre-sales (+6) — NinjaOne/Pulsora/Oracle pattern |
| **Comp 78** | Discovery, tailored demos, RFP/POV, exec stakeholders; domain learnable (innovation/IP SaaS) |
| **Fit 70** | Remote WE, mature SaaS (founded 2003), craft-of-pre-sales culture |
| **Bumps** | Recency +10, profitable +8, low apps +5, FR/EU lang preferred +4, lane +6 |
| **Score** | Base 76 + 33 bumps → **100** (clamped) |
...
| 60 | — | 360Dialog — Project Manager EMEA | https://euremotejobs.com/job/project-manager-emea-remote/ |
| 55 | — | Luvent — Project Manager (French) | https://www.luvent-consulting.com/jobs/project-manager/ |
| 55 | 115 | KWS — Procurement Risk & Sustainability Manager | https://www.linkedin.com/jobs/view/4457353110/ |
| 54 | — | RelationalAI — Solution Engineer | https://euremotejobs.com/job/solution-engineer/ |
| 41 | — | OSF — Grants Officer | https://unjobs.org/vacancies/1788697557228 |
