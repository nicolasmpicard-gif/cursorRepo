...
|------:|-----:|---------|------|-------|
| **98** | <25 | 🟢 Apply now | **Beiersdorf — Sustainability TPO** | Internal sustainability IT PO; EN fluent only; Power BI/APIs/data; Hamburg; +4 PM internal data/AI |
| **79** | — | 🟡 Apply soon | **Cohere — PM Managed North** | Enterprise AI managed offering PM; Berlin office / remote-friendly; data/AI PM +3; Series B+ |
| **65** | — | 🟠 Apply if time | RelationalAI — Solution Engineer | Coding-heavy SE (Python/SQL/PRs in customer env) — weak vs Nic solutions/impl lane |
| **DQ** | 54 | 🔴 Skip | Upvest — Sr Solutions Consultant (Pre-Sales) | Investment/brokerage infrastructure — **financial_services** essential |
| **DQ** | 75 | 🔴 Skip | BCG Platinion — Consultant Commodity Trading | **Fluent German** + commodity/ETRM trading domain |
| **Skip** | 200+ | 🔴 Skip | Ethereum Foundation — PM Academic Engagements | Academic partnerships / research programs — not delivery PM |

### Beiersdorf — why 98
| Factor | Detail |
|--------|--------|
| **Lane** | Technical Product Owner — internal sustainability digital products (`product_manager` + `data_ai_internal` +4) |
| **Domain** | Sustainability process digitalization / compliance data — climate adjacent |
| **Language** | Fluent English only ✓ (no DE stated) |
| **Company** | Beiersdorf public / profitable (+8) |
| **Score** | Base 71 (Comp 70 / Fit 72) + recency +10 + apps +5 + funding +8 + pm +4 = **98** |

### Cohere — why 79
| Factor | Detail |
|--------|--------|
| **Lane** | PM for managed/self-serve North (AI infra product) — `data_ai_product` +3 |
| **Company** | Cohere well-funded Series B+ (+8); Berlin presence |
| **Drag** | Infra/model-serving PM stretch vs Nic’s SaaS impl/solutions core |
| **Score** | Base 68 (Comp 66 / Fit 70) + funding +8 + pm +3 = **79** |
...
| 65 | — | RelationalAI — Solution Engineer | https://euremotejobs.com/job/solution-engineer/ |
...
| Verdict | Role | Why |
|--------:|------|-----|
| **DQ** | Upvest — Sr Solutions Consultant | financial_services / investment infrastructure essential |
| **DQ** | BCG Platinion — Commodity Trading | fluent German + commodity trading |
| **DQ** | Kira / EasyPark / EverAI / SDG | prior DQs |
| **Skip** | Ethereum Foundation — Academic Engagements PM | academic program lane |
