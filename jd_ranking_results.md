...
**Skipped:** Coach-Hub, Filigran, Executive Integrity, Hostinger (growth/partnerships background), Lokalise (UK/Latvia/Spain only), Mistral (5+ yrs AI/LLM enterprise product — not a match), Rydoo (listing ~1 month old), Nash (too technical), Personio GTM (sales systems / Salesforce CPQ experience gap).  
...
#    Score   Company — Role
------------------------------------------------------------------------------------------
1    78      Insider One — Solutions Consultant, DACH
2    78      ESMT Berlin — Program Manager, Global Online MBA
3    77      Kleinanzeigen — Senior PM PRO Performance
4    76      Typeform — Senior Product Manager
5    74      Planet — D&I Program Manager, Professional Services
...
## Also scored lower
Almedia (55), Aquent (42), Siemens Energy, vCluster Labs (vMetal), Nucs AI, Neo4j, Tanium, Wikimedia, WhiteTech, Eaton, Scaleo, Parts-Cloud, Ruby Labs, Gypsy Collective
