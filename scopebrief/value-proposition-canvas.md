# Value Proposition Canvas — Scopebrief (working title)
...
### Customer jobs (what they are trying to get done)

- Allocate this year’s climate / Scope 3 budget in a way that survives Einkauf, CFO, and (if in scope) CSRD/ESRS E1 scrutiny
- Show progress toward a Scope 3 or science-based target without over-claiming
- Decide where to engage tier-1 suppliers vs where to stop
- Brief leadership in one sitting, not after a 6-week consultancy
- Improve data quality over time (spend-based → PCF) without pretending the numbers are already primary
- Keep production-critical suppliers stable (qualification, single source, CBAM-exposed metals)

### Pains

- Footprint tools show hotspots; they do not say which € will **change the THG-Bilanz** vs which € only buy a story
- Insetting and offsetting get treated as substitutes; auditors and SBTi do not
- Spend lives in SAP; emissions live in a consultant Excel; criticality lives in Einkauf’s head
- Named tier-2 suppliers are mostly unknown — and the user will be wrong about them
- Fear of greenwashing if residual credits are netted off Scope 3
- Limited budget, many nodes, no ranking that combines tonnes, leverage, and claim type
- “At a glance” moments (Vorstand, budget round) with no artifact they can forward
...
- Optional “probable upstream structure” (process stage / likely origin cluster), never a true/false T2 quiz
...
- Ranking that combines spend concentration, production criticality, inferred material lever, and confidence
...
## Fit (how the map meets the profile)
